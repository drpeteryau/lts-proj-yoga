...
class YogaData {
  ...
  static final List<YogaPose> beginnerWarmup = [
    YogaPose(
      ...
      nameKey: 'Head, Neck and Shoulders Stretch',
      descriptionKey: 'Gentle stretches to release tension in head, neck and shoulders',
...
Ear to Shoulder: Drop right ear to right shoulder. Right palm holds head. Bend left arm behind back. Hold 5 breaths. Repeat other side. Do 3 times each side.''',
    ...
    YogaPose(
      ...
      nameKey: 'Straight Arms Rotation',
      descriptionKey: 'Rotate arms to warm up shoulders',
    ...
    YogaPose(
      ...
      nameKey: 'Bent Arm Rotation',
      descriptionKey: 'Shoulder mobility with bent arms',
    ...
    YogaPose(
      ...
      nameKey: 'Shoulders Lateral Stretch',
      descriptionKey: 'Side body stretch',
    ...
    YogaPose(
      ...
      nameKey: 'Shoulders and Torso Twist',
      descriptionKey: 'Spinal twist for detoxification',
      imageUrl: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=500',
      durationSeconds: 90,
  ...
  static final List<YogaPose> beginnerMainSitting = [
    YogaPose(
      id: 'beginner_main_1',
      nameKey: 'Leg Raise (Bent)',
      descriptionKey: 'Strengthen legs and core',
    ...
    YogaPose(
      id: 'beginner_main_2',
      nameKey: 'Leg Raise (Straight)',
      descriptionKey: 'Advanced leg strengthening',
    ...
    YogaPose(
      id: 'beginner_main_3',
      nameKey: 'Goddess Pose (Torso Twist)',
      descriptionKey: 'Side stretch in wide leg position',
    ...
    YogaPose(
      id: 'beginner_main_4',
      nameKey: 'Goddess Pose (Leg Stretch)',
      descriptionKey: 'Strengthen legs in wide stance',
      imageUrl: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=500',
      durationSeconds: 60,
  ...
  static final List<YogaPose> beginnerMainStanding = [
    YogaPose(
      ...
      nameKey: 'Back and Chest Stretch',
      descriptionKey: 'Full body stretch with chair support',
      imageUrl: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=500',
      durationSeconds: 90,
    ...
    YogaPose(
      ...
      nameKey: 'Standing Crunch',
      descriptionKey: 'Core strengthening with leg movement',
      imageUrl: 'https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?w=500',
      durationSeconds: 90,
    ...
    YogaPose(
      ...
      nameKey: 'Warrior 3',
      descriptionKey: 'Balance and strengthen',
      imageUrl: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=500',
      durationSeconds: 90,
    ...
    YogaPose(
      ...
      nameKey: 'Warrior 1',
      descriptionKey: 'Leg strengthening and spinal stretch',
      imageUrl: 'https://images.unsplash.com/photo-1588286840104-8957b019727f?w=500',
      durationSeconds: 90,
    ...
    YogaPose(
      ...
      nameKey: 'Warrior 2',
      descriptionKey: 'Leg and back strengthening',
      imageUrl: 'https://images.unsplash.com/photo-1603988363607-e1e4a66962c6?w=500',
      durationSeconds: 90,
    ...
    YogaPose(
      ...
      nameKey: 'Triangle Pose',
      descriptionKey: 'Strengthen legs and expand chest',
      imageUrl: 'https://images.unsplash.com/photo-1599447292326-e6daae7ae9cb?w=500',
      durationSeconds: 90,
    ...
    YogaPose(
      ...
      nameKey: 'Reverse Warrior 2',
      descriptionKey: 'Strengthen obliques and legs',
      imageUrl: 'https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=500',
      durationSeconds: 90,
    ...
    YogaPose(
      ...
      nameKey: 'Side Angle Pose',
      descriptionKey: 'Deep side stretch and strengthening',
      imageUrl: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=500',
      durationSeconds: 90,
  ...
  static final List<YogaPose> beginnerCooldown = [
    YogaPose(
      ...
      nameKey: 'Seated Rest',
      descriptionKey: 'Return to calm seated position',
      imageUrl: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=500',
      durationSeconds: 120,
  ...
  static final List<YogaPose> intermediateMain = [
    YogaPose(
      id: 'intermediate_1',
      nameKey: 'Downward Facing Dog',
      descriptionKey: 'Inverted V position - full body strengthening',
      imageUrl: 'https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?w=500',
      durationSeconds: 90,
...
Strengthens legs, feet, arms, hands, back and core. Invigorates brain by reducing fatigue.''',
    ...
    YogaPose(
      id: 'intermediate_2',
      nameKey: 'Plank Pose',
      descriptionKey: 'Core strengthening in straight line position',
      imageUrl: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=500',
      durationSeconds: 90,
...
Feet together for level-up practice. Strengthens entire core, arms, and legs.''',
    ...
    YogaPose(
      id: 'intermediate_3',
      nameKey: 'Eight-Point Pose (Ashtangasana)',
      descriptionKey: 'Caterpillar pose for arm strength',
      imageUrl: 'https://images.unsplash.com/photo-1588286840104-8957b019727f?w=500',
      durationSeconds: 90,
...
Realigns spine, strengthens chin, neck, arms.''',
    ...
    YogaPose(
      id: 'intermediate_4',
      nameKey: 'Baby Cobra',
      descriptionKey: 'Gentle backbend for spine strengthening',
      imageUrl: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=500',
      durationSeconds: 90,
...
Strengthens spine, expands lung capacity, alleviates backache. Lift palms from mat for level-up.''',
    ...
    YogaPose(
      id: 'intermediate_5',
      nameKey: 'Full Cobra (Bhujangasana)',
      descriptionKey: 'Deep backbend for spine and chest',
      imageUrl: 'https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?w=500',
      durationSeconds: 90,
...
Strengthens spine and arm strength, expands lung capacity, alleviates backache, stimulates pelvic region.''',
  ...
  static final List<YogaPose> advancedFlow = [
    YogaPose(
      id: 'advanced_1',
      nameKey: 'Sun Salutation Flow',
      descriptionKey: 'Dynamic flow combining 5 poses - one breath, one movement',
      imageUrl: 'https://images.unsplash.com/photo-1588286840104-8957b019727f?w=500',
      durationSeconds: 300,
...
Benefits: Strengthening, stretching, cardio, breath awareness. Builds heat, stamina, and mental focus.''',
  ...
  static final List<YogaSession> beginnerSessions = [
    YogaSession(
      id: 'beginner_1',
      titleKey: 'Gentle Chair Yoga - Full Session',
      levelKey: 'Beginner',
      descriptionKey: 'Complete chair yoga session suitable for most people. Practice on empty stomach or 2 hours after meal.',
    ...
    YogaSession(
      id: 'beginner_2',
      titleKey: 'Chair Yoga - Seated Focus',
      levelKey: 'Beginner',
      descriptionKey: 'Focus on seated chair poses. Great for limited mobility.',
    ...
    YogaSession(
      id: 'beginner_3',
      titleKey: 'Chair Yoga - Standing Focus',
      levelKey: 'Beginner',
      descriptionKey: 'Chair-supported standing poses for balance and strength.',
    ...
    YogaSession(
      id: 'beginner_4',
      titleKey: 'Quick Chair Yoga',
      levelKey: 'Beginner',
      descriptionKey: 'Shorter session for busy days.',
  ...
  static final List<YogaSession> intermediateSessions = [
    YogaSession(
      id: 'intermediate_1',
      titleKey: 'Hatha Yoga - Foundation',
      levelKey: 'Intermediate',
      descriptionKey: 'Classic hatha yoga poses on the mat. Build strength and flexibility.',
    ...
    YogaSession(
      id: 'intermediate_2',
      titleKey: 'Hatha Yoga - Core Focus',
      levelKey: 'Intermediate',
      descriptionKey: 'Emphasize core strengthening poses.',
      totalDurationMinutes: 20,
    ...
    YogaSession(
      id: 'intermediate_3',
      titleKey: 'Hatha Yoga - Backbends',
      levelKey: 'Intermediate',
      descriptionKey: 'Focus on spine flexibility and chest opening.',
      totalDurationMinutes: 20,
  ...
  static final List<YogaSession> advancedSessions = [
    YogaSession(
      id: 'advanced_1',
      titleKey: 'Sun Salutation Flow',
      levelKey: 'Advanced',
      descriptionKey: 'Dynamic vinyasa flow. One breath, one movement. Builds stamina and focus.',
      totalDurationMinutes: 20,
      warmupPoses: [],
    ...
    YogaSession(
      id: 'advanced_2',
      titleKey: 'Extended Sun Salutation',
      levelKey: 'Advanced',
      descriptionKey: 'Longer practice with more rounds. Challenge yourself.',
      totalDurationMinutes: 30,
      warmupPoses: [],
      mainPoses: advancedFlow,
      cooldownPoses: [],
